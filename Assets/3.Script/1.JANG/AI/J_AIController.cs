...
public class J_AIController : MonoBehaviour
{
    ...
    public readonly J_AlertState alertState = new J_AlertState();
    public readonly J_CombatState combatState = new J_CombatState();
    ...
    // FSM Control
    // ===============================
    public void ChangeState(J_IState newState)
    {
